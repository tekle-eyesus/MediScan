        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
                ...
                children: [
                  pw.Expanded(
                    child: pw.Column(children: [
                      pw.Text("Original X-Ray"),
                      pw.SizedBox(height: 5),
                      pw.Image(pw.MemoryImage(imageBytes), height: 200),
                    ]),
                  ),
                  pw.SizedBox(width: 20),
                  if (result['heatmap_base64'] != null)
                    pw.Expanded(
                      child: pw.Column(children: [
                        pw.Text("AI Analysis"),
                        pw.SizedBox(height: 5),
                        // Decode base64 to bytes for PDF
                        pw.Image(
                            pw.MemoryImage(
                                base64Decode(result['heatmap_base64'])),
                            height: 200),
                      ]),
                    ),
                ],
              ...
              pw.Paragraph(
                  text:
                      "The AI system has analyzed the chest X-ray. The analysis indicates a ${(result['confidence'] * 100).toStringAsFixed(1)}% probability of ${result['prediction']}. Please correlate with clinical symptoms."),
              ...
              pw.Divider(),
              pw.Text(
                  "Electronically generated by MediScan AI. Not a final diagnosis.",
                  style:
